...
### install the required package 'rootSolve' 
...
############# Function: AdmixProp3way ######

AdmixProp3way <- function(null_vector, risk_freq, grr){
...
############# Power calculation ##############
############ Function: PowerCase3way ##########
###############################################
PowerCase3way <- function(null_vector, risk_freq, grr, alpha, sample_size){
  alt_vector <- AdmixProp3way(null_vector, risk_freq, grr)
...
PowerCC3way <- function(null_prop, risk_freq, grr,
                                    sample_case, sample_control, alpha){
alt_prop <- AdmixProp3way(null_prop, risk_freq, grr)
...
SampleCC3way <- function(null_prop, risk_freq, grr,
                                     alpha, beta){
  alt_prop <- AdmixProp3way(null_prop, risk_freq, grr)
